...
var TiMail = function TiMail(_ref) {
  var name = _ref.name,
    label = _ref.label,
    ...
    validate = _ref$validate === void 0 ? 'default' : _ref$validate,
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    value: value,
    onChange: onChange,
    className: "border-2 border-gray-400 rounded-lg transition duration-75 py-3 px-4 pr-11 w-full font-bold tracking-wider text-lg text-gray-700 leading-tight focus:outline-none focus:shadow-outline ".concat(valid === true ? 'border-green-500' : '', " ").concat(submit && valid === false ? 'border-red-500' : '')
  }), /*#__PURE__*/_react["default"].createElement("div", {
    className: "absolute z-40 inset-y-0 w-11 right-0 flex items-center px-3 rounded-r-lg focus:outline-none space-x-2"
  }, state && loader ? /*#__PURE__*/_react["default"].createElement("div", {
    ...
    role: "status"
  }) : valid === false && submit ? /*#__PURE__*/_react["default"].createElement(_reactIcons.IconContext.Provider, {
    value: {
      size: '1.5em',
  ...
  }, /*#__PURE__*/_react["default"].createElement(_ti.TiTick, null)) : null)), errorMessage && valid === false && submit ? /*#__PURE__*/_react["default"].createElement("h1", {
    className: "block transition-all duration-300 text-red-500 mt-2 font-semibold tracking-wide"
  }, errorMessage) : null);
};
