...
function TiPassword(_ref) {
  var name = _ref.name,
    ...
    _ref$showPass = _ref.showPass,
    showPass = _ref$showPass === void 0 ? false : _ref$showPass,
  ...
  var _useState5 = (0, _react.useState)('password'),
    ...
    inpType = _useState6[0],
    setInpType = _useState6[1];
  ...
  }), showPass ? /*#__PURE__*/_react["default"].createElement("button", {
  ...
  }, /*#__PURE__*/_react["default"].createElement(_im.ImEyeBlocked, null))) : null), errorMessage && !valid && submit ? /*#__PURE__*/_react["default"].createElement("h1", {
