...
export function Form({ initialValues = {}, className, onSubmit, children }) {
...
// 					className={`rounded-lg selection:select-none transition duration-75 py-3 px-4 pr-11 w-full font-semibold tracking-wider text-lg leading-tight ${
// 						readOnlyText ? 'border-0 outline-none' : 'border-2'
// 					} border-2 outline-none focus:shadow-outline ${
...
// export function Label({ name, title, ...restProps }) {
// 	return (
